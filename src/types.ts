...
export interface Post {
  ...
  author: Author;
  images: string[];
  imageTransforms?: { scale: number; x: number; y: number; aspect?: number }[];
  caption: string;
  likes: number;
  comments: number;
  date: string;
...
export const MOCK_AUTHORS: Record<string, Author> = {
  "andi": {
    ...
    isFollowing: false,
    bio: "Community builder & tech enthusiast. Loving the Friendszone vibe! 🚀",
    gender: "Male",
    location: "Jakarta, ID",
    joinedDate: "October 2023",
    followerCount: 1250,
    followingCount: 320,
    banner: "https://picsum.photos/seed/andibanner/1200/400"
  },
  "siska": {
    id: "siska",
    name: "Siska Amelia",
    avatar: "https://picsum.photos/seed/siska/100/100",
    isFollowing: true,
    bio: "Coffee addict ☕ | Digital Nomad | Life is short, travel more.",
    gender: "Female",
    location: "Bali, ID",
    joinedDate: "January 2024",
    followerCount: 890,
    followingCount: 450,
    banner: "https://picsum.photos/seed/siskabanner/1200/400"
  },
  "rizky": {
    id: "rizky",
    name: "Rizky Fauzi",
    ...
    isFollowing: false,
    bio: "Professional Gamer 🎮 | Member of Friendszone E-sports Team.",
    gender: "Male",
    location: "Bandung, ID",
    joinedDate: "March 2024",
    followerCount: 2400,
    followingCount: 180,
    banner: "https://picsum.photos/seed/rizkybanner/1200/400"
  }
};
...
export const MOCK_POSTS: Post[] = [
  {
    id: "1",
    author: MOCK_AUTHORS["andi"],
    images: [
      "https://picsum.photos/seed/trip1/800/800",
      "https://picsum.photos/seed/trip2/800/800",
      "https://picsum.photos/seed/trip3/800/800",
    ],
    caption: "Great moments with the Friendszone community at yesterday's gathering! Didn't expect it to be this crowded. 🔥 #friendszone #community",
    likes: 452,
    comments: 2,
    date: "2 hours ago",
    commentList: [
      {
        id: "c1",
        author: { id: "john", name: "johndoe", avatar: "https://picsum.photos/seed/john/100/100" },
        text: "Wow truly amazing event! Cant wait for the next one.",
        likes: 12,
        date: "1h",
        replies: [
          {
            id: "r1",
            author: MOCK_AUTHORS["andi"],
            text: "Thanks John! See you there next time!",
            likes: 2,
            date: "30m"
          }
        ]
      ...
      {
        id: "c2",
        author: { id: "sarah", name: "sarah_smith", avatar: "https://picsum.photos/seed/sarah/100/100" },
  ...
  {
    id: "2",
    author: MOCK_AUTHORS["siska"],
    images: [
      "https://picsum.photos/seed/cafe/800/800",
    ],
    caption: "Coffee session this afternoon. Anyone want to join for a casual chat?",
    likes: 120,
    comments: 0,
    date: "5 hours ago",
    commentList: []
  ...
  {
    id: "3",
    author: MOCK_AUTHORS["rizky"],
    images: [
      "https://picsum.photos/seed/game1/800/800",
      "https://picsum.photos/seed/game2/800/800",
    ],
    caption: "Crushing it at the Friendszone internal tournament last night! GGWP team! 🎮✨",
    likes: 890,
    comments: 5,
    date: "Yesterday",
    commentList: []
...
const DUPLICATE_COUNTRIES = [
  ...
  { name: "Other", code: "OT", dialCode: "custom", flag: "🌐" },
];

export const COUNTRIES = Array.from(
  new Map(DUPLICATE_COUNTRIES.map(item => [item.code, item])).values()
).sort((a, b) => a.name === "Other" ? 1 : b.name === "Other" ? -1 : a.name.localeCompare(b.name));

export const isUsernameTaken = (username: string) => {
  const taken = ["admin", "root", "friendzone", "fanra", "andi", "siska", "budi"];
  return taken.includes(username.toLowerCase());
};

export const isPhoneTaken = (phone: string) => {
  const taken = ["088291298977", "123456789"];
  return taken.includes(phone.replace(/\s/g, ""));
};
